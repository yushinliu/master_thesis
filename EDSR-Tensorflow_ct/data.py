...
def load_dataset(data_dir):
	img_set=[]
	try:
		for addr_1 in os.listdir(str(data_dir)+"//DATASET-Train-augmented-120//battery"):
			print("addr_1",addr_1)
			for img in os.listdir(str(data_dir)+"//DATASET-Train-augmented-120//battery//"+str(addr_1)):
				print("img",img)
				img_set.append(scipy.misc.imread(str(data_dir)+"//DATASET-Train-augmented-120//battery//"+str(addr_1)+"//"+str(img)))
	except:
		print("wrong")
	return img_set
